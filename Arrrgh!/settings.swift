...
enum E_PLAYABLE_CHARACTERS: Int{
...
//
//    init(typeMessage: String, stringMessage: String, intMessage: Int, img: String) {
//        self.typeMessage = typeMessage
//        self.stringMessage = stringMessage
//        self.intMessage = intMessage
//        messageImg = img
//    }
//
//    static func decode(messageData: Data) -> messageStruct {
//        return try! JSONDecoder().decode(messageStruct.self, from: messageData)
//    }
//
//    func encode() -> Data {
